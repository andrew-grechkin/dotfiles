return {
    { -- https://github.com/nvim-treesitter/nvim-treesitter
        ...
        config = function()
            ...
            local config = {
                ensure_installed = {
                    'bash', 'c', 'cmake', 'cpp', 'css', 'dockerfile', 'elixir', 'gitignore', 'html',
                    'http', 'javascript', 'json', 'lua', 'make', 'markdown', 'markdown_inline',
                    'python', 'query', 'regex', 'ruby', 'scss', 'sql', 'toml', 'tsx', 'typescript',
                    'vim', 'vue', 'yaml',
                },
