return {
    ...
    {'mgrabovsky/vim-cuesheet', enabled = not IS_KVM, ft = {'cue'}},
    {'pearofducks/ansible-vim', enabled = not IS_KVM, ft = {'yaml'}},
    {'potamides/pantran.nvim', enabled = not IS_KVM},
    {'tmux-plugins/vim-tmux', enabled = not IS_KVM},
    {'vimwiki/vimwiki', enabled = not IS_KVM, cmd = {'VimwikiIndex'}},
    -- 'vim-ruby/vim-ruby',
