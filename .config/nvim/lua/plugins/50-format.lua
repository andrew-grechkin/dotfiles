    ...
    { -- https://github.com/stevearc/conform.nvim
        ...
        opts = {
            formatters = {
                ...
                ['format-yaml'] = {command = 'format-yaml'},
                ['format-yaml-full'] = {
                    command = 'format-yaml',
                    env = {['FORMAT_YAML_MODE'] = 'full'},
                },
            ...
            formatters_by_ft = {
                ...
                cpp = {'clang-format'},
                css = {'prettierd'},
                -- eruby = {'htmlbeautifier'}, -- piece of shit
                -- eruby = {'erb_format'},
                fb2 = {'xmllint'},
                ...
                json = {'fixjson', 'jq'},
                jsonc = {'fixjson'},
                jsonl = {'fixjson', 'jq-sort-one-line'},
                lua = {'lua-format'},
                markdown = {'prettierd'},
            ...
            formatters_by_ft_manual = {
                json = {'jq-sort'},
                jsonc = {'jq-sort'},
                jsonl = {'jq-sort', 'jq-sort-one-line'},
                -- perl = {'perlimports'},
                python = {'isort'},
                yaml = {'format-yaml-full'},
            },
