...
-antigen-env-setup () {
  ...
  -antigen-set-default _ANTIGEN_THEME_COMPAT false
...
-antigen-cache-execute () {
  ...
  antigen-apply-cached () {
    ...
    if [[ $ANTIGEN_AUTO_CONFIG == true && $#ANTIGEN_CHECK_FILES -eq 0 ]]; then
      ANTIGEN_CHECK_FILES+=("$ZDOTDIR/antigen.zsh" "$ZDOTDIR/.zshenv" "$ZDOTDIR/.zshrc" "$ZDOTDIR/.zlogin" "$ZDOTDIR/.zprofile")
