...
[[ -d "/opt/usr/bin/core_perl"                          ]] && path+=("/opt/usr/bin/core_perl")
[[ -d "/opt/usr/bin/site_perl"                          ]] && path+=("/opt/usr/bin/core_perl")
[[ -d "/opt/usr/bin/vendor_perl"                        ]] && path+=("/opt/usr/bin/vendor_perl")
