...
FZF_GIT_DEFAULT_ARGS=(
	...
	--bind="alt-t:become(fzf-git-files-changed)"
...
FZF_GIT_DEFAULT_FOOTER='A-c: A-i: A-I:change A-d:diff C-x:dump A-t:status enter:take | C-y:yank A-b:browse A-p:preview'
